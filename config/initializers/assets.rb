...
Rails.application.config.assets.precompile += %w( users.coffee.erb )
Rails.application.config.assets.precompile += %w( about.coffee.erb )
Rails.application.config.assets.precompile += %w( user_approval.js.coffee )
